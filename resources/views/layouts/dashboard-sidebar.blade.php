    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li class="nav-item has-submenu">
            ...
            <ul class="submenu collapse">
                <li><a class="nav-link" href="{{ route('hrms.create') }}">New Application</a></li>
                <li><a class="nav-link" href="#">Floor Shifting</a></li>
                <li><a class="nav-link" href="#">Category Shifting</a></li>
